...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sumit Nagar — Python Developer" },
      { name: "description", content: "Portfolio of Sumit Nagar, an aspiring Python developer building efficient, scalable software." },
      { name: "author", content: "Sumit Nagar" },
